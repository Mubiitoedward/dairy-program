            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="breadcrumb__text">
                        <h2 class ="text-center" style = "color:#1c7430"> Your Chosen Items</h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="breadcrumb__links">
                                ...
                                <tr>
                                    <td class="product__cart__item">
                                        ...
                                        <div class="product__cart__item__text">
                                            <h6><%out.println(rs.getString("ProductName"));%></h6>
                                            <h5></h5>
                                        </div>
                                    </td>
                                    ...
                                    <td class="cart__price"><%out.println(rs.getInt("OrderPrice")*rs.getInt("OrderQuantity"));%></td>
                                    <td><span> 
                                            <form action = "RemoveCart">
                                                <input type ="hidden" name="orderID" value="<%rs.getString("OrderQuantity");%>"
...
<!--                    <div class="cart__discount">
                    ...
                    <div class="cart__total" style="background-color:#1c7430 ">
                        <h6 class ="" style = "color: #fff">Cart total</h6>
                        <ul>
                            <li class ="" style = "color: #fff">Subtotal <span>   <%   out.println(AllTotal);%></span></li>
                            <li class ="" style = "color: #fff">Total <span><%   out.println(AllTotal);%></span></li>
                        </ul>
                        <a href="#" class="primary-btn">BUY THE PRODUCTS</a>
         </div>
                </div>
