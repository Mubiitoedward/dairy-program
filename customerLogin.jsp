        ...
        <div class="card" style="border-radius: 2rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-block">
              <img src="login.jpg" alt="login form" class="img-fluid" style="border-radius: 2rem 0 0 1rem;"  />
            </div>
              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="CustomerLogin" >
                  ...
                  <div class="d-flex align-items-center mb-3 pb-1">
                    ...
                    <span class="h1 fw-bold mb-0">DAIRY FRESH</span>
                  </div>
                  ...
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="customerRegg.jsp"
