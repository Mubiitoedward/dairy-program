...
public class AddingToTheDataBase extends HttpServlet {
            ...
            try{
                Class.forName("com.mysql.jdbc.Driver");
                 try{     
                    ...
                    st.executeUpdate("insert into productstable(ProductName,UnitPrice,ProductType,Description, Image)values('"+pname+"','"+price+"','"+pcat+"','"+desc+"','"+imagepath+"')");
                out.println("warrup deh");
